...
public class reportLostItemSceneController {
    ...
    public TextField description_textArea;
    public TextField location_textArea;
    ...
    {
        AppProperties filestorage_properties = new AppProperties("filestorage");
        MinioClient minioClient =
                MinioClient.builder()
                        .endpoint(filestorage_properties.prop.getProperty("url"))
                        .credentials(filestorage_properties.prop.getProperty("access_key"), filestorage_properties.prop.getProperty("secret_key"))
                        .build();

        try {
            String bucket_name = filestorage_properties.prop.getProperty("bucket_name");
